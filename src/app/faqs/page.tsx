import { Container, Footer, PreFooter, SectionBgResources } from "@/components";
...
export default function FaqsPage() {
    return (
        <div className="flex flex-col bg-inherit">
            ...
            <Container>
                <section className="w-full py-12 bg-bg-gray-section grid grid-cols-3 gap-x-20">
