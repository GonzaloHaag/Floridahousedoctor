    ...
    return (
        <div className="flex flex-col bg-inherit">
            ...
            <div className="w-full bg-bg-gray-section">
                <Container>
                    <section className="w-full py-12 bg-inherit grid grid-cols-1 lg:grid-cols-3 gap-x-20 gap-y-5">
                            ...
                            <div className="flex flex-col gap-y-10">
                                <Accordion type="single" collapsible className="w-full">
                                    <AccordionItem value="item-1">
                                        <AccordionTrigger className="text-start">Can I find home service professional for any project on your directory?</AccordionTrigger>
                                    ...
                                    <AccordionItem value="item-2">
                                        <AccordionTrigger className="text-start">Is there a cost to use the directory?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-3">
                                        <AccordionTrigger className="text-start">How are home service professional vetted before being listed?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-4">
                                        <AccordionTrigger className="text-start">How do you rate the businesses?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-5">
                                        <AccordionTrigger className="text-start">How do I get in touch with a business I find in the directory?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-6">
                                        <AccordionTrigger className="text-start">How can I list my business in the directory?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-7">
                                        <AccordionTrigger className="text-start">Is my personal information safe when I use the directory?</AccordionTrigger>
                                        <AccordionContent className="text-start">
                                    ...
                                    <AccordionItem value="item-8">
                                        <AccordionTrigger className="text-start">What if I have a complaint about a business listed in the directory?</AccordionTrigger>
                                        <AccordionContent className="text-start">
