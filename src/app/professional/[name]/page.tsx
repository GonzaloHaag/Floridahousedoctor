...
export default async function ProfessionalByNamePage({ params }: Props) {
    ...
    return (
        <div className="flex flex-col w-full bg-inherit">
            <section className="w-full h-[23.75rem] bg-[url('/images/hsd-bg05.webp')] bg-cover flex flex-col items-center gap-y-4 relative">
                <div className="flex flex-col items-center mt-24 gap-y-4">
                    <h1 className="text-slate-100 text-4xl font-bold text-center">{decodeURIComponent(name)}</h1>
                ...
                <Container>
                    <div className="flex flex-col mt-5">
                        <div className="bg-white rounded border-8 border-yellow-site px-4 lg:px-6 pb-4 relative">
                            ...
                            <div className="flex flex-col lg:grid lg:grid-cols-8 gap-12 py-6 w-full">
                                <Image src={plumber?.Image_URL ? plumber.Image_URL : '/images/placeholder_image.webp'} alt={plumber?.Name ? plumber.Name : 'Placeholder image'} sizes="100vw" width={0} height={0} className="w-full h-full object-cover aspect-video rounded col-span-1 lg:col-span-2" />
                                <div className="flex flex-col gap-y-4 col-span-full lg:col-span-4">
                                    ...
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <span className="text-slate-900 text-sm md:text-base font-medium">{plumber?.Category ? plumber.Category : 'Uncategorized'}</span>
                                    </div>
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <span className="text-slate-900 text-sm md:text-base font-medium">15+ Years in Business</span>
                                    </div>
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <span className="text-slate-900 text-sm md:text-base font-medium">{plumber?.Full_Address ? plumber.Full_Address : 'No Address'}</span>
                                    </div>
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 mt-6">
                            ...
                            <Link href={'#highlights'} title="Highlights" className="bg-white flex items-center justify-center text-center py-2 px-4 rounded text-blue-site hover:bg-blue-site hover:text-slate-100 transition-colors duration-300">
                                Highlights
                            </Link>
                            <Link href={'#services'} title="Services" className="bg-white flex items-center justify-center text-center py-2 px-4 rounded text-blue-site hover:bg-blue-site hover:text-slate-100 transition-colors duration-300">
                                Services
                            </Link>

                            <Link href={'#credentials'} title="Credentials" className="bg-white flex items-center justify-center text-center py-2 px-4 rounded text-blue-site hover:bg-blue-site hover:text-slate-100 transition-colors duration-300">
                                Credentials
                            </Link>
                            <Link href={'#'} title="Projects" className="bg-white flex items-center justify-center text-center py-2 px-4 rounded text-blue-site hover:bg-blue-site hover:text-slate-100 transition-colors duration-300">
                                Projects
                            </Link>
                            <Link href={'#'} title="Reviews" className="bg-white flex items-center justify-center text-center py-2 px-4 rounded text-blue-site hover:bg-blue-site hover:text-slate-100 transition-colors duration-300">
                                Reviews
                            </Link>
                        </div>
                        <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 pb-10">
                            <div className="w-full bg-inherit flex flex-col gap-y-8 pl-0 lg:pl-8 my-6 col-span-full lg:col-span-4">
                            ...
                            <div className="col-span-2 flex flex-col gap-y-6 lg:mt-20">
                                <div className="flex items-center gap-x-2">
