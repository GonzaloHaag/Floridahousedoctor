...
export default function HomePage() {
  return (
    <div className="flex flex-col w-full">
      <section className="w-full min-h-[80dvh] lg:min-h-dvh bg-[url('/images/hsd-bg01.webp')] bg-cover bg-left lg:bg-center bg-no-repeat flex flex-col justify-center text-slate-100 py-10">
        <Container>
          <div className="flex flex-col gap-y-4 w-full lg:w-[50%]">
            <h1 className="text-3xl md:text-6xl font-bold w-full text-center lg:text-start text-pretty leading-[1.1em]">
              Experience the Best in Home <span className="text-yellow-site">Building</span>
            </h1>
            <p className="w-full font-medium text-base lg:text-lg">
            ...
            <Search />
            <span className="text-base lg:text-lg">Popular Searches: HVAC, Plumbing, Kitchen Remodeling, Home Inspection,…</span>

            <div className="grid grid-cols-1 sm:grid-cols-3 justify-start gap-x-4 gap-y-6 text-slate-100 w-full max-w-[31rem]">
              <div className="flex flex-col gap-y-4 justify-center items-center text-center bg-[#466DAB] rounded h-full w-36 p-4 mx-auto sm:mx-0">
      ...
      <div className="w-full bg-bg-gray-section py-16 flex flex-col gap-y-10">
        ...
        <section className="w-full bg-inherit">
          <Container>
            <div className="w-full flex flex-col md:flex-row items-center gap-x-10 gap-y-6 bg-[url('/images/hsd-bg02.webp')] bg-cover bg-no-repeat bg-center bg-blue-site px-10 py-8 min-h-[440px] rounded">
              <div className="text-slate-100 max-w-[16.25rem] flex flex-col gap-y-2">
                ...
                <p className="font-bold text-3xl md:text-[2.5rem] leading-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-6">
                <div className="bg-white rounded px-2 flex flex-col gap-y-4 items-center text-center py-6">
                  <Image src={'/images/step1.webp'} alt="step1" width={300} height={300} className="aspect-square" />
                  <h3 className="text-2xl text-blue-site font-bold">SEARCH</h3>
                </div>
                <div className="bg-white rounded px-2 flex flex-col gap-y-4 items-center text-center py-6">
                  <Image src={'/images/step2.webp'} alt="step1" width={300} height={300} className="aspect-square" />
                  <h3 className="text-2xl text-blue-site font-bold">BROWSE</h3>
                </div>
                <div className="bg-white rounded px-2 flex flex-col gap-y-4 items-center text-center py-6">
                  <Image src={'/images/step3.webp'} alt="step1" width={300} height={300} className="aspect-square" />
