    ...
    return (
        <header className="w-full flex flex-col">
            <div className="w-full bg-blue-site flex items-center min-h-10">
                <div className="w-full container mx-auto max-w-7xl px-8 flex items-center justify-center lg:justify-between text-slate-100">
            ...
            <div className="bg-white w-full flex items-center border-b-2 min-h-24">
                <div className="w-full container mx-auto max-w-7xl px-8 flex items-center justify-between relative">
                    <Link href={'/'} title="Home page">
                        <Image priority src={'/images/hsd-logo.webp'} alt="Logo hsd" sizes="100vw" width={0} height={0} className="aspect-auto w-[160px] h-[40px] md:w-[260px] md:h-[60px]" />
                    </Link>
