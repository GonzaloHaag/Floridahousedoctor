    ...
    return (
        <header className="w-full flex flex-col">
            <div className="w-full bg-blue-site flex items-center min-h-10">
                <div className="w-full container mx-auto max-w-7xl px-4 flex items-center justify-center lg:justify-between text-slate-100">
            ...
            <div className="bg-white w-full flex items-center border-b-2 min-h-24">
                <div className="w-full container mx-auto max-w-7xl px-4 flex items-center justify-between relative">
