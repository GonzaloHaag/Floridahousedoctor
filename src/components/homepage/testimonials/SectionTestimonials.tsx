...
export const SectionTestimonials = () => {
    return (
        <section className="w-full min-h-[90vh] bg-[url('/images/hsd-bg04.webp')] bg-blue-site bg-cover bg-center p-20">
            <div className="flex flex-col gap-y-4 text-center items-center text-slate-100">
                <h4 className="text-5xl font-bold">Real Stories, Genuine Experiences</h4>
            ...
            <div className="grid grid-cols-2 gap-x-6 max-w-[1600px] mx-auto items-center mt-10">
