        ...
        <div className="flex flex-col gap-y-4 rounded group bg-white fade-in-0 animate-in duration-500">
            <div className="relative overflow-hidden rounded">
                <Link href={'/gutter'} title="Gutter" className="rounded">
                    <Image src={'/images/gutterrepair.webp'} alt="gutter" width={0} height={0} sizes="100vw" className="relative w-full h-full rounded transition-transform duration-500 hover:scale-125 aspect-square" />
                </Link>
