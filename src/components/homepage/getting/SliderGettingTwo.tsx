            ...
            <CarouselContent>
                    <CarouselItem className="md:basis-1/2 lg:basis-1/4">
                        <div className="p-1 flex flex-col gap-y-4 items-center text-center">
                            <Image src={'/images/home-improvement.webp'} alt="home-improvement" width={200} height={100} className="rounded-t" />
                    ...
                    <CarouselItem className="md:basis-1/2 lg:basis-1/4">
                        <div className="p-1 flex flex-col gap-y-4 items-center text-center">
                            <Image src={'/images/bathroom-remodeling.webp'} alt="bathroom" width={200} height={100} className="rounded-t" />
