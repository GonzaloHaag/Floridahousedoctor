export const Pagination = () => {
    return (
        <nav aria-label="Page navigation example" className="w-full flex justify-center items-center mt-10">
            <ul className="inline-flex -space-x-px text-sm">
                ...
                <li>
                    <a href="#" className="flex items-center justify-center px-3 h-8 leading-tight text-blue-600 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">1</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#" aria-current="page" className="flex items-center justify-center px-3 h-8 text-gray-500 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700">3</a>
                </li>
                <li>
